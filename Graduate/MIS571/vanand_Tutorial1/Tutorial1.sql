...
.output AnandVandana_Tutorial01_out.txt
...
CONSTRAINT  order_detail_o_id_fk FOREIGN KEY (ol_o_id) REFERENCES orders(ord_id),
CONSTRAINT  order_detail_inv_id_fk FOREIGN KEY (ol_inv_id) REFERENCES inventory(inv_id),
CONSTRAINT  order_detail_oid_invid_pk PRIMARY KEY (ol_o_id, ol_inv_id));
...
(1, DATE('2006-09-15'), NULL);

INSERT INTO shipment VALUES
(2, DATE('2006-11-15'), NULL);

INSERT INTO shipment VALUES
(3, DATE('2006-06-25'), NULL);

INSERT INTO shipment VALUES
(4, DATE('2006-06-25'), NULL);

INSERT INTO shipment VALUES
(5, DATE('2006-08-15'), '121 Gate Street');
