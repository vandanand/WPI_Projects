...
'''
   ...
   We have another CSV file 'Salaries.csv', which contains the player salary information in all years.
...
def search_salary(X, year=2002):
    '''
        ...
        For example, if we want to evaluate players for year 2002, we need to search for salary of the player in year 2002.
        Input:
